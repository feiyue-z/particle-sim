...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function cd(){return new Wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ah(),fragmentShader:`
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function ld(){return new Wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ah(),fragmentShader:`
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function Ah(){return`
...
`)}function LM(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function Rr(s){return s!==""}function vd(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Md(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const DM=/^[ \t]*#include +<([\w\d./]+)>/gm;function Bl(s){return s.replace(DM,UM)}const FM=new Map;function UM(s,e){let t=qe[e];if(t===void 0){const n=FM.get(e);if(n!==void 0)t=qe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Bl(t)}const OM=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Td(s){return s.replace(OM,BM)}function BM(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Sd(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function zM(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===pf?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Om?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ri&&(e="SHADOWMAP_TYPE_VSM"),e}function VM(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ws:case Xs:e="ENVMAP_TYPE_CUBE";break;case wa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function kM(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Xs:e="ENVMAP_MODE_REFRACTION";break}return e}function HM(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case eh:e="ENVMAP_BLENDING_MULTIPLY";break;case ng:e="ENVMAP_BLENDING_MIX";break;case ig:e="ENVMAP_BLENDING_ADD";break}return e}function GM(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function WM(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=zM(t),l=VM(t),h=kM(t),u=HM(t),d=GM(t),f=PM(t),m=IM(r),x=i.createProgram();let g,p,E=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Rr).join(`
`)),o=Bl(o),o=vd(o,t),o=Md(o,t),a=Bl(a),a=vd(a,t),a=Md(a,t),o=Td(o),a=Td(a),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const v=E+g+o,_=E+p+a,C=xd(i,i.VERTEX_SHADER,v),R=xd(i,i.FRAGMENT_SHADER,_);i.attachShader(x,C),i.attachShader(x,R),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function w(P){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(x).trim(),B=i.getShaderInfoLog(C).trim(),q=i.getShaderInfoLog(R).trim();let Y=!0,X=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,C,R);else{const J=yd(i,C,"vertex"),G=yd(i,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
`):e.addLineFlowCode(`${t}Barrier()`,this)}}ne(Ob);class Kn extends rn{static get type(){return"AtomicFunctionNode"}constructor(e,t,n,i=null){super("uint"),this.method=e,this.pointerNode=t,this.valueNode=n,this.storeNode=i}getInputType(e){return this.pointerNode.getNodeType(e)}getNodeType(e){return this.getInputType(e)}generate(e){const t=this.method,n=this.getNodeType(e),i=this.getInputType(e),r=this.pointerNode,o=this.valueNode,a=[];a.push(`&${r.build(e,i)}`),o!==null&&a.push(o.build(e,i));const c=`${e.getMethod(t,n)}( ${a.join(", ")} )`;if(this.storeNode!==null){const l=this.storeNode.build(e,i);e.addLineFlowCode(`${l} = ${c}`,this)}else e.addLineFlowCode(c,this)}}Kn.ATOMIC_LOAD="atomicLoad";Kn.ATOMIC_STORE="atomicStore";Kn.ATOMIC_ADD="atomicAdd";Kn.ATOMIC_SUB="atomicSub";Kn.ATOMIC_MAX="atomicMax";Kn.ATOMIC_MIN="atomicMin";Kn.ATOMIC_AND="atomicAnd";Kn.ATOMIC_OR="atomicOr";Kn.ATOMIC_XOR="atomicXor";ne(Kn);const Bb=wt(s=>{const{lightDistance:e,cutoffDistance:t,decayExponent:n}=s,i=e.pow(n).max(.01).reciprocal();return t.greaterThan(0).select(i.mul(e.div(t).pow4().oneMinus().clamp().pow2()),i)});wt(({color:s,lightViewPosition:e,cutoffDistance:t,decayExponent:n},i)=>{const r=i.context.lightingModel,o=e.sub(Hn),a=o.normalize(),c=o.length(),l=Bb({lightDistance:c,cutoffDistance:t,decayExponent:n}),h=s.mul(l),u=i.context.reflectedLight;r.direct({lightDirection:a,lightColor:h,reflectedLight:u},i.stack,i)});wt(([s=Oa()],{renderer:e,material:t})=>{const n=Vn(1).toVar(),i=Xp(s.mul(2).sub(1));if(t.alphaToCoverage&&e.samples>1){const r=Vn(i.fwidth()).toVar();n.assign(zh(r.oneMinus(),r.add(1),i).oneMinus())}else i.greaterThan(1).discard();return n});const Ps=[],um=[],dm=[],fm=[],pm=1e-4,bi=new bt,Ma=new bt,Ta=new bt,Sa=new bt,Ea=new bt;let $l=null;function zb(s){$l=s,bi.children.length!==0&&(Ma.clear(),Ta.clear(),Sa.clear(),Ea.clear(),s.remove(bi)),console.log(`pathsData.length = ${Ps.length}`);const e=30;for(let t=Math.max(0,Ps.length-e);t<Ps.length;t++){const n=Ps[t],i=jb(),r=new jf(n),o=Wb(n,i),a=Xb(r,i);Ma.add(o),Ta.add(a),um.push({curve:r,cones:a});const c=Zb(r,i);Sa.add(c.mesh),fm.push(c);const l=qb(r,Kb(i));Ea.add(l),dm.push({curve:r,glows:l})}mm(),Ps.length=0}function Vb(s){Ps.push(s)}function mm(){if(!$l)return;bi.clear();const{mode:s}=Ds;switch(s){case Fi.CLASSIC:Ma!=null&&Ta!=null&&(bi.add(Ma),bi.add(Ta));break;case Fi.TAPE:Sa!=null&&bi.add(Sa);break;case Fi.NEON:Ea!=null&&bi.add(Ea);break}$l.add(bi)}function gm(){const{mode:s,animation:e}=Ds;if(e)switch(s){case Fi.CLASSIC:kb();break;case Fi.TAPE:Gb();break;case Fi.NEON:Hb();break}}function kb(){um.forEach(({curve:s,cones:e})=>{const t=e.count;console.log("classic count = "+t);const n=new lt;for(let i=0;i<t;i++){let r=e.userData.ts[i];r+=pm,r>=1&&r--,e.userData.ts[i]=r;const o=s.getPoint(r),a=s.getTangent(r).normalize(),c=new bn;c.setFromUnitVectors(new N(0,1,0),a),n.position.copy(o),n.quaternion.copy(c),n.updateMatrix(),e.setMatrixAt(i,n.matrix)}e.instanceMatrix.needsUpdate=!0})}function Hb(){dm.forEach(({curve:s,glows:e})=>{const t=e.count;console.log("glow count = "+t);const n=new lt;for(let i=0;i<t;i++){let r=e.userData.ts[i];r+=pm,r>=1&&r--,e.userData.ts[i]=r;const o=s.getPoint(r);n.position.copy(o),n.updateMatrix(),e.setMatrixAt(i,n.matrix)}e.instanceMatrix.needsUpdate=!0})}function Gb(){fm.forEach(s=>{s.currentSegment+=.1,s.currentSegment>s.totalSegments&&(s.currentSegment=0);const e=[],t=Math.floor(s.currentSegment);for(let n=0;n<t;n++){const i=n*2,r=n*2+1,o=n*2+2,a=n*2+3;e.push(i,r,a,i,a,o)}s.geometry.setIndex(e),s.geometry.computeVertexNormals()})}function Wb(s,e=0){const t=new Ht,n=new Float32Array(s.length*3);for(let r=0;r<s.length;r++)n[r*3+0]=s[r].x,n[r*3+1]=s[r].y,n[r*3+2]=s[r].z;t.setAttribute("position",new Yt(n,3));const i=new ba({color:e});return new Qr(t,i)}function Xb(s,e=0){const t=Math.floor(s.getLength()*5),n=$b(t,e),i=new lt,r=[];for(let o=0;o<t;o++){const a=o/t;r.push(a);const c=s.getPoint(a),l=s.getTangent(a).normalize(),h=new N(0,1,0),u=new bn().setFromUnitVectors(h,l);i.position.copy(c),i.quaternion.copy(u),i.updateMatrix(),n.setMatrixAt(o,i.matrix)}return n.userData.ts=r,n.instanceMatrix.needsUpdate=!0,n}function qb(s,e=0,t=10){const n=s.getLength(),i=Math.min(1,t/n),r=Math.floor(n*10*i),o=Yb(r,e),a=new lt,c=[];for(let l=0;l<r;l++){const h=l/r*i;c.push(h);const u=s.getPoint(h);a.position.copy(u),a.updateMatrix(),o.setMatrixAt(l,a.matrix)}return o.userData.ts=c,o.instanceMatrix.needsUpdate=!0,o}function $b(s,e){const t=new xh(.01,.03,6,1),n=new Bn({color:e});return new dh(t,n,s)}function Yb(s,e){const t=new ir(.01),n=new _S({glowColor:e});return new dh(t,n,s)}function Zb(s,e,t=100){const i=[];for(let c=0;c<=t;c++){const l=c/t,h=s.getPoint(l),u=s.getTangent(l).normalize(),d=l*Math.PI*4;let f=new N(0,1,0);Math.abs(u.dot(f))>.99&&(f=new N(1,0,0));const m=new N().crossVectors(u,f).normalize();f.crossVectors(m,u).normalize();const x=new bn().setFromAxisAngle(u,d);f.applyQuaternion(x);const g=h.clone().addScaledVector(f,-.05/2),p=h.clone().addScaledVector(f,.05/2);i.push(g.x,g.y,g.z),i.push(p.x,p.y,p.z)}const r=new Ht;r.setAttribute("position",new zt(i,3)),r.setIndex([]);const o=new yh({color:e,side:Mn});return{mesh:new It(r,o),geometry:r,totalSegments:t,currentSegment:0}}function jb(){const s=Math.random(),e=.5+Math.random()*.5,t=.1+Math.random()*.2,n=new De;return n.setHSL(s,e,t),n}function Kb(s){const e={h:0,s:0,l:0};s.getHSL(e),e.l-=.2,e.l=Math.max(.05,Math.min(1,e.l));const t=new De;return t.setHSL(e.h,e.s,e.l),t}const of=["textures/bubble/bubble_1.png","textures/bubble/bubble_2.png","textures/bubble/bubble_3.png","textures/bubble/bubble_4.png","textures/bubble/bubble_5.png","textures/bubble/bubble_6.png","textures/bubble/bubble_7.png"];class Jb extends g0{constructor(e,t){const n=of[Math.floor(Math.random()*of.length)],r=new op().load(n),o=new Wf({map:r,transparent:!0,blending:ca,depthWrite:!1});super(o),this.scale.set(.2,.2,1),this.position.copy(e),this.velocity=t.clone(),this.lifetime=150,this.age=0,this.path=[],this.frustumCulled=!1,this.userData={type:"particle"}}}class Qb extends It{constructor(e,t){const n=e1(),i=new eo(.1,.05),r=new Bn({color:n});super(i,r),this.position.copy(e),this.velocity=t.clone(),this.angularVelocity=t1(),this.color=n,this.age=0,this.lifetime=150,this.path=[],this.frustumCulled=!1,this.userData={type:"particle"}}}function e1(){const s=Math.random(),e=.5+Math.random()*.5,t=.7+Math.random()*.2,n=new De;return n.setHSL(s,e,t),`#${n.getHexString()}`}function t1(s=10){return new N((Math.random()-.5)*2*s,(Math.random()-.5)*2*s,(Math.random()-.5)*2*s)}class n1 extends It{constructor(e,t){const n=new ir(.05,32,32),i=new yh({color:16777215});super(n,i),this.position.copy(e),this.velocity=t.clone(),this.velocity.z=-3,this.angularVelocity=i1(),this.orbitCenter=e.clone(),this.age=0,this.lifetime=150,this.path=[],this.frustumCulled=!1,this.userData={type:"particle"}}}function i1(s=3){return new N((Math.random()-.5)*s,(Math.random()-.5)*s,(Math.random()-.5)*s)}const s1=-.4,af=1/3;let ka=null,Ri=[],kc=0,Yl=!1;function r1(s){ka=s}function xm(s){a1(s),Yl&&Ri.length===0&&(Yl=!1,zb(ka))}function _m(s,e){for(Yl=!0,kc+=is.rate*s;kc>=af;)o1(e),kc-=af}function o1(s){const e=new N((Math.random()-.5)*.5*is.spread,0,(Math.random()-.5)*.5*is.spread);s.add(e);let t;const n=c1(30,60,1,2,0,1);switch(is.type){case zn.BUBBLE:t=new Jb(s,n);break;case zn.CONFETTI:t=new Qb(s,n);break;case zn.BALL:t=new n1(s,n);break}ka.add(t),Ri.push(t)}function a1(s){for(let e=Ri.length-1;e>=0;e--){const t=Ri[e];if(t.age++,t.age==t.lifetime){Vb(t.path),Ri[e]=Ri[Ri.length-1],Ri.pop(),ka.remove(t);continue}const{mass:n,gravity:i,jitterFactor:r,drag:o}=Ki[is.type],a=t.velocity.clone().multiplyScalar(-o);if(t.angularVelocity){t.angularVelocity.multiplyScalar(1-o*s);const m=t.angularVelocity.clone().multiplyScalar(s);if(t.rotation.x+=m.x,t.rotation.y+=m.y,t.rotation.z+=m.z,t.orbitCenter){const x=t.position.clone().sub(t.orbitCenter),g=new N().crossVectors(t.angularVelocity,x);t.velocity.add(g.multiplyScalar(s))}}const h=new N(0,i,0).clone().add(a.multiplyScalar(1/n)).multiplyScalar(s);t.velocity.add(h);const u=t.velocity.clone().multiplyScalar(s);t.position.add(u);const d=new N((Math.random()-.5)*.1*r,(Math.random()-.5)*.1*r,(Math.random()-.5)*.1*r);t.position.add(d);const f=0;t.position.y<=f&&(t.position.y=f,t.velocity.y*=s1),t.path.push(t.position.clone())}}function c1(s,e,t,n,i,r){const o=Hc(s,e),a=Hc(t,n),c=a*Math.cos(o),l=a*Math.sin(o),h=Hc(i,r);return new N(c,h,l)}function Hc(s,e){return Math.random()*(e-s)+s}let ra;function l1(){const s=new ir(1e3,32,32),e=`
    ...
    `,n=new Wn({uniforms:{iResolution:{value:new ae(window.innerWidth,window.innerHeight)},iTime:{value:0}},vertexShader:e,fragmentShader:t,side:en});return ra=new It(s,n),ra.position.set(0,0,0),ra}function ym(){ra.material.uniforms.iTime.value=performance.now()*.001}let Zl=null;const vm=9877247,jl=5698944,Kl=new bt;function h1(){return new Promise((s,e)=>{new vT().load("fonts/helvetiker_regular.typeface.json",n=>{Zl=n,s(n)},void 0,n=>e(n))})}class Ha extends It{constructor(e,t,n,i={}){const{depth:r=.05,color:o=16777215}=i,a=new Lr;a.moveTo(-e/2+n,-t/2),a.lineTo(e/2-n,-t/2),a.quadraticCurveTo(e/2,-t/2,e/2,-t/2+n),a.lineTo(e/2,t/2-n),a.quadraticCurveTo(e/2,t/2,e/2-n,t/2),a.lineTo(-e/2+n,t/2),a.quadraticCurveTo(-e/2,t/2,-e/2,t/2-n),a.lineTo(-e/2,-t/2+n),a.quadraticCurveTo(-e/2,-t/2,-e/2+n,-t/2);const c=new Ca(a,{depth:r,bevelEnabled:!1}),l=new yh({color:o,transparent:!0,opacity:.75});super(c,l),this.color=o,this.frustumCulled=!1,this.userData={type:"ui"}}setColor(e){this.material.color.set(e)}resetColor(){this.material.color.set(this.color)}}class $r extends lt{constructor(e,t={}){const{color:n=0,size:i=.2,depth:r=.01}=t;if(!Zl){console.error("Font not loaded!");return}super(),this.text=String(e),this.color=n,this.size=i,this.depth=r,this.createTextMesh()}createTextMesh(){const e=new yT(this.text,{font:Zl,size:this.size,depth:this.depth});e.center();const t=new Bn({color:this.color});this.mesh=new It(e,t),this.add(this.mesh)}setText(e){this.text=String(e),this.mesh&&(this.remove(this.mesh),this.mesh.geometry.dispose(),this.mesh.material.dispose()),this.createTextMesh()}}class Mm extends Ha{constructor(e,t,n,i={}){const{size:r=.2}=i;super(e,t,.12),this.textMesh=new $r(n,{size:r}),this.textMesh.position.set(0,0,.1),this.add(this.textMesh)}setText(e){this.textMesh.setText(e)}}class ns extends Ha{constructor(e,t,n,i){super(e,t,.12,{color:vm}),this.callback=i,this.textMesh=new $r(n),this.textMesh.position.set(0,0,.1),this.textMesh.raycast=()=>null,this.textMesh.layers.set(1),this.add(this.textMesh),this.userData={type:"button"}}onClick(){this.callback()}}class cf extends Ha{constructor(e,t,n,i,r,o,a){const{min:c=-1/0,max:l=1/0,displayer:h=null}=a;super(e,t,.12,{color:vm}),this.getValue=i,this.setValue=r,this.delta=o,this.min=c,this.max=l,this.displayer=h,this.textMesh=new $r(n),this.textMesh.position.set(0,0,.1),this.textMesh.raycast=()=>null,this.textMesh.layers.set(1),this.add(this.textMesh),this.userData={type:"button"}}onClick(){const e=this.getValue()+this.delta;e>=this.min&&e<=this.max&&(this.setValue(e),this.displayer&&this.displayer.setValueText(this.getValue().toFixed(2)))}}class u1 extends Ha{constructor(e,t,n,i={}){const{textSize:r=.2,getValue:o=null}=i;super(e,t,.2),this.tagMesh=new $r(n,{size:r}),this.tagMesh.position.set(0,.15,.1),this.tagMesh.raycast=()=>{},this.valueMesh=new $r(o?o().toFixed(2):"--",{size:r}),this.valueMesh.position.set(0,-.15,.1),this.valueMesh.raycast=()=>{},this.add(this.tagMesh),this.add(this.valueMesh)}setValueText(e){this.valueMesh.setText(e)}}function zr(s,e,t,n,i={}){const{min:r=-1/0,max:o=1/0}=i,a=new u1(2,.8,s,{getValue:e}),c=new cf(.5,.5,"-",e,t,-n,{min:r,max:o,displayer:a}),l=new cf(.5,.5,"+",e,t,n,{min:r,max:o,displayer:a}),h=[c,a,l];Ga(h,1.4);const u=new bt;return h.forEach(d=>u.add(d)),u}function d1(){const s=is,e=new Mm(3,.6,"Emitter Control"),t=zr("Rate",()=>s.rate,o=>s.rate=o,5,{min:0,max:25}),n=zr("Spread",()=>s.spread,o=>s.spread=o,.5,{min:0,max:3}),i=[e,t,n];Tm(i,1);const r=new bt;return i.forEach(o=>r.add(o)),r}function f1(){const s=new Mm(3,.6,"Visualization Control");s.position.set(0,2,0);const e=new ns(2.4,.6,"Start animation",function(){Ds.animation=!Ds.animation,Ds.animation?this.setColor(jl):this.resetColor()});e.position.set(0,1,0);const t=new ns(1.5,.6,"Classic",()=>c(0)),n=new ns(1.5,.6,"Tape",()=>c(1)),i=new ns(1.5,.6,"Neon",()=>c(2)),r=[t,n,i];let o=-1;const a=new bt;r.forEach(h=>a.add(h)),Ga(r,2);function c(h){h!==o&&(o!==-1&&r[o].resetColor(),o=h,r[o].setColor(jl),Ds.mode=Object.values(Fi)[o],mm())}const l=new bt;return l.add(s),l.add(e),l.add(a),c(0),l}function Gc(s){const e=zr("Gravity",()=>Ki[s].gravity,o=>Ki[s].gravity=o,1,{min:-100,max:100}),t=zr("Jitter",()=>Ki[s].jitterFactor,o=>Ki[s].jitterFactor=o,.1,{min:0,max:1}),n=zr("Drag",()=>Ki[s].drag,o=>Ki[s].drag=o,.1,{min:0,max:1}),i=[e,t,n];Tm(i);const r=new bt;return i.forEach(o=>r.add(o)),r}function p1(){const s=Gc(zn.BUBBLE),e=Gc(zn.CONFETTI),t=Gc(zn.BALL),n=[s,e,t];let i=null;const r=new bt,o=new ns(1.5,.6,"Bubble",()=>d(0)),a=new ns(1.5,.6,"Confetti",()=>d(1)),c=new ns(1.5,.6,"Ball",()=>d(2)),l=[o,a,c];let h=-1;const u=new bt;l.forEach(f=>u.add(f)),Ga(l);function d(f){f!==h&&(h!==-1&&(r.remove(i),l[h].resetColor()),h=f,i=n[h],r.add(i),l[h].setColor(jl),is.type=Object.values(zn)[h],Sm())}return r.add(u),d(0),r}function Ga(s,e=2){const t=-((s.length-1)*e)/2;s.forEach((n,i)=>{n.position.x=i*e+t})}function Tm(s,e=1){const t=-((s.length-1)*e)/2;s.forEach((n,i)=>{n.position.y=-i*e+t})}function Sm(){pa.length=0,Kl.traverse(s=>{var e;((e=s.userData)==null?void 0:e.type)==="button"&&pa.push(s)})}function m1(){const s=d1(),e=f1(),t=new bt;t.add(s),t.add(e),t.rotateY(Math.PI/3);const n=p1();n.rotateY(-Math.PI/3);const i=[t,n];return Ga(i,8),i.forEach(r=>Kl.add(r)),Sm(),Kl}const Ni=new Map;let Em=0,Am=0;const Yo=new ae,Yr=new ae,wm=new N;let Aa=!1;const Yh=new ap;Yh.layers.set(0);let Ui=null,g1=new N;const lf=.02,hf=.001;function x1(s,e){window.addEventListener("resize",()=>{e.setSize(window.innerWidth,window.innerHeight),s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix()}),window.addEventListener("mousedown",t=>{Aa=!0,uf(t),df(s),v1(s),M1(s),T1()}),window.addEventListener("mousemove",t=>{uf(t),y1(t),df(s)}),window.addEventListener("mouseup",()=>{Aa=!1,Ui=null}),document.addEventListener("keydown",t=>{Ni.set(t.code,!0)}),document.addEventListener("keyup",t=>{Ni.set(t.code,!1)})}function _1(s,e){Aa&&!Ui&&_m(s,wm),Ni.get("KeyW")&&e.translateZ(-.02),Ni.get("KeyS")&&e.translateZ(lf),Ni.get("KeyA")&&e.translateX(-.02),Ni.get("KeyD")&&e.translateX(lf),Ni.get("ShiftLeft")&&(e.rotation.x=Em*hf,e.rotation.y=Am*hf)}function uf(s){Yr.x=s.clientX/window.innerWidth*2-1,Yr.y=-(s.clientY/window.innerHeight)*2+1}function df(s){if(!Aa)return;const e=new N(Yr.x,Yr.y,.5);e.unproject(s);const t=e.clone().sub(s.position).normalize();wm.copy(s.position.clone().add(t.multiplyScalar(3)))}function y1(s){const e=s.clientX-Yo.x,t=s.clientY-Yo.y;Yo.x=s.clientX,Yo.y=s.clientY,Ni.get("ShiftLeft")&&(Em+=t,Am+=e)}function v1(s){Yh.setFromCamera(Yr,s)}function M1(s){const e=Yh.intersectObjects(pa,!0);e.length!==0&&(Ui=e[0].object,g1.copy(e[0].point).sub(Ui.position),s.position.distanceTo(Ui.position))}function T1(){Ui&&Ui.userData.type=="button"&&Ui.onClick()}const oa=new ap;oa.far=10;let Jl=!1,Oi=null,S1=new N,E1=new N,aa=null;function A1(s,e){s.addEventListener("selectstart",t=>{Jl=!0,C1(s),R1(s),N1()}),s.addEventListener("selectend",()=>{Jl=!1,Oi=null}),s.addEventListener("squeeze",()=>{e.visible=!e.visible}),s.addEventListener("connected",t=>{console.log("Controller connected:",t.data.handedness),w1(s)})}function w1(s){const e=new ba({color:16711680}),t=[new N(0,0,0),new N(0,0,-1)],n=new Ht().setFromPoints(t);aa=new Qr(n,e),aa.scale.z=3,s.add(aa)}function b1(s){if(Jl&&!Oi){const e=aa.localToWorld(new N(0,0,-.3));_m(s,e)}}function R1(s){s.matrixWorld.decompose(E1,new bn,new N)}function C1(s){oa.ray.origin.setFromMatrixPosition(s.matrixWorld),oa.ray.direction.set(0,0,-1).applyQuaternion(s.quaternion);const e=oa.intersectObjects(pa,!0);e.length!==0&&(Oi=e[0].object,S1.copy(e[0].point).sub(Oi.position),s.position.distanceTo(Oi.position))}function N1(){Oi&&Oi.userData.type=="button"&&Oi.onClick()}const an=new m0,cn=new _T({antialias:!0,alpha:!0}),Zr=new Qt(75,window.innerWidth/window.innerHeight,.01,5e3),ff=cn.xr.getController(1),bm=new wx,Rm=new Fr;P1();function P1(){Zr.position.set(0,2,3),cn.xr.enabled=!0,cn.setPixelRatio(window.devicePixelRatio),cn.setSize(window.innerWidth,window.innerHeight),I1(),document.body.appendChild(cn.domElement),document.body.appendChild(rS.createButton(cn)),document.body.appendChild(Rm.dom);const s=new l1;an.add(s),an.add(ff);const e=new na(16777215,1.2);e.position.set(5,10,5),e.target.position.set(0,2,-3),an.add(e),an.add(e.target);const t=new na(16777215,.6);t.position.set(-5,5,2),t.target.position.set(0,2,-3),an.add(t),an.add(t.target);const n=new na(16777215,.8);n.position.set(0,4,-6),n.target.position.set(0,2,-3),an.add(n),an.add(n.target);const i=new Sx(16777215,.3);an.add(i),r1(an);const r=new xS,o=cn.xr.getControllerGrip(1);o.add(r.createControllerModel(o)),an.add(o),h1().then(()=>{const a=m1();a.position.set(0,2,-3),an.add(a),x1(Zr,cn),A1(ff,s)})}function I1(s){cn.setAnimationLoop((e,t)=>{let n=bm.getDelta();n=Math.min(n,.1),ym(),_1(n,Zr),xm(n),gm(),cn.render(an,Zr),Rm.update()})}cn.xr.addEventListener("sessionstart",()=>{if(console.log("XR session started."),!cn.xr.getSession()){console.error("No active XR session found!");return}L1()});function L1(s){cn.setAnimationLoop((e,t)=>{let n=bm.getDelta();n=Math.min(n,.1),ym(),b1(n),xm(n),gm(),cn.render(an,Zr)})}
